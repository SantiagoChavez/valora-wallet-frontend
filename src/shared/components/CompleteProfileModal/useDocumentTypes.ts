...
// null mientras no resolvió o si falló — CompleteProfileModal cae al label
// genérico "Documento" en cualquiera de los dos casos (ver documentLabel),
// sin bloquear el formulario por un catálogo que no cargó.
