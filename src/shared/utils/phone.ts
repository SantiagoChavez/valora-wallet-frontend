...
// pegado directo al número. Si `code` no matchea ningún PHONE_COUNTRY_CODES,
// es `dialCode` el que queda en "" (no la función entera) — el resultado es
// el número local sanitizado solo, sin prefijo (no debería pasar — los 3
// consumidores solo ofrecen valores de esa misma lista en su selector — pero
// es el mismo fallback que ya usaban los 3 antes de esta extracción,
